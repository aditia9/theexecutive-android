...
object Constants {
    ...
    const val PRODUCT_MEDIA_URL: String = "product_media_url"
    const val CATEGORY_MEDIA_URL: String = "category_media_url"
    ...
    const val VOUCHER_AMT: String = "voucher_amount"
    const val SUBS_MESSAGE: String = "subscription_message"
    const val PROMOTION_MESSAGE: String = "home_promotion_message"
    ...
    const val PRODUCT_LIST_RESPONSE: String = "product_list_response"
    ...
    const val AIMATION_DURATION: Long = 300
