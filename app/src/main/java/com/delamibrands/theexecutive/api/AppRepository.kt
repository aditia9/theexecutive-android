...
import com.delamibrands.theexecutive.api.interfaces.ApiService
import com.delamibrands.theexecutive.modules.bankTransfer.BankTransferRequest
import com.delamibrands.theexecutive.modules.bankTransfer.Recipients
import com.delamibrands.theexecutive.modules.bankTransfer.TransferMethodsDataClass
import com.delamibrands.theexecutive.modules.category.CategoryResponseDataClass
import com.delamibrands.theexecutive.modules.category.PromotionsResponseDataClass
import com.delamibrands.theexecutive.modules.changePassword.ChangePasswordDataClass
import com.delamibrands.theexecutive.modules.checkout.CheckoutDataClass
import com.delamibrands.theexecutive.modules.forgotPassword.ForgotPasswordDataClass
import com.delamibrands.theexecutive.modules.login.LoginDataClass
import com.delamibrands.theexecutive.modules.myAccount.MyAccountDataClass
import com.delamibrands.theexecutive.modules.notification.dataclasses.DeviceRegisterRequest
...
import com.delamibrands.theexecutive.modules.order.orderList.OrderListResponse
import com.delamibrands.theexecutive.modules.order.orderReturn.OrderReturnRequest
...
import com.delamibrands.theexecutive.modules.shoppingBag.ShoppingBagQtyUpdateRequest
import com.delamibrands.theexecutive.modules.shoppingBag.ShoppingBagResponse
import com.delamibrands.theexecutive.modules.shoppingBag.TotalResponse
...
import com.delamibrands.theexecutive.modules.wishlist.MoveToBagRequest
import com.delamibrands.theexecutive.modules.wishlist.WishlistResponse
...
//
    ...
    fun orderComment(orderId: String?, request: CheckoutDataClass.OrderCommentRequest, callBack: ApiCallback<String>){
        val retrofit = ApiClient.retrofit
        val userToken: String? = SavedPreferences.getInstance()?.getStringValue(Constants.USER_ACCESS_TOKEN_KEY)
        val storeCode: String = SavedPreferences.getInstance()?.getStringValue(Constants.SELECTED_STORE_CODE_KEY) ?: Constants.DEFAULT_STORE_CODE
        val callPost = retrofit?.create<ApiService.CheckoutService>(ApiService.CheckoutService::class.java)?.orderComment(ApiConstants.BEARER + userToken, storeCode, orderId, request)
    ...
    fun getNotificationList(callBack: ApiCallback<List<NotificationListResponse>>) {
       ...
       val request = DeviceRegisterRequest("", "", SavedPreferences.getInstance()?.getStringValue(Constants.ANDROID_DEVICE_ID_KEY))
    ...
    fun logoutNotification( callBack: ApiCallback<Boolean>) {
        ...
        val request = NotificationChangeStatusRequest("",  SavedPreferences.getInstance()?.getStringValue(Constants.ANDROID_DEVICE_ID_KEY), SavedPreferences.getInstance()?.getStringValue(Constants.USER_ACCESS_TOKEN_KEY))
