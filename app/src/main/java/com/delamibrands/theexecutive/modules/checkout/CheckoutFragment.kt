...
import com.delamibrands.theexecutive.databinding.FragmentCheckoutBinding
import com.delamibrands.theexecutive.databinding.PaymentMethodItemBinding
import com.delamibrands.theexecutive.databinding.ShippingMethodItemBinding
    ...
    private fun observeApiResponse() {
        ...
        checkoutViewModel.paymentMethodList.observe(this, Observer { paymentMethodList ->
            ...
            if (paymentMethodList?.size ?: 0 <= 0) {
                ...
                tv_payment_method.text = "${getString(R.string.payment_method)}"
            }
        })
