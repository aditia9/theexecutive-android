...
import com.delamibrands.theexecutive.databinding.StoreListItemBinding
import com.delamibrands.theexecutive.modules.splash.StoreResponse

/**
 * Created by nikhil on 16/3/18.
 */
class StoreListAdapter(private var storeListData: List<StoreResponse>?, var selectedStoreCode: String): RecyclerView.Adapter<StoreListAdapter.Holder>() {
