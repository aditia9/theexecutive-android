package com.delamibrands.theexecutive.rangeBar;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.range_bar_thumb;
        int thumbPressed = R.drawable.range_bar_thumb;
        int thumbDisabled = R.drawable.range_bar_thumb;
    ...
    /**
     * Sets the currently default currency value.
     *
     * @param currency The String value to set the default currency value to.
     */
       ...
       /* if (showLabels) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            if (!singleThumb) {
                ...
                canvas.drawText(mCurrency+minText,
                        minPosition,
            ...
            canvas.drawText(mCurrency+maxText,
                    maxPosition,
                    distanceToTop + textSize,
                    paint);
        }
